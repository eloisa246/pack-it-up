...
ROOMS.bathroom = {
  ...
  objects: [
    ...
    { id: "sill_bottles",    name: "Windowsill Bottles",  category: "decor",    x: 248, y: 208, z: 3, removable: true, value: 7,
      check: "A tiny skyline of glass bottles. Yours — they came with you, they leave with you." },
...
ROOMS.office = {
  ...
  objects: [
    ...
    { id: "waste_bin",       name: "Wastebasket",      category: "decor",     x: 600, y: 296, z: 4, removable: true, value: 3,
      check: "Yours. Empty it before it goes in a box, though." },
    { id: "side_cabinet",    name: "Side Cabinet",     category: "furniture", x: 664, y: 288, z: 3, removable: true, value: 30,
      check: "Yours, and it holds more than it looks like. Open it for contents, or handle the cabinet itself." },
