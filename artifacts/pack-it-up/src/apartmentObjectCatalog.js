...
const PACKABLE_OBJECTS = {
  bedroom: [
    ...
    ["art_poster", "Coin Co. Poster"], ["sill_plants", "Windowsill Plants"],
    ["hanging_plant", "Hanging Pothos"], ["bed", "Bed"], ["nightstand", "Nightstand"],
  ...
  bathroom: [
    ...
    ["sill_bottles", "Windowsill Bottles"], ["toilet_decor", "Tank-top Decor"],
  ...
  office: [
    ...
    ["storage_bin", "Storage Tote"], ["waste_bin", "Wastebasket"],
    ["side_cabinet", "Side Cabinet"], ["wifi_router", "Wi-Fi Router"],
    ["cat_bed", "Stretchy's Bed"],
  ],
  kitchen: [
    ["kettle", "Blue Kettle"], ["cutting_board", "Cutting Board"],
    ["dish_rack", "Dish Rack"], ["sill_plants_k", "Windowsill Herbs"],
    ["fridge_plant", "Fridge-top Plant"], ["door_towel", "Striped Towel"],
    ["cat_food_bowl", "Cat Food Bowl"], ["cat_water_bowl", "Water Bowl"],
  ],
  dining: [
    ["dining_curtains", "Green Curtains"], ["sill_plants_d", "Sill Succulents"],
  ...
  living: [
    ["tv_hutch", "TV Hutch"], ["wall_art_pair", "Wall Art"], ["sofa", "Leather Loveseat"],
