...
// first campaign felt easy, the finale felt hard. This player agrees; the
// naive one (naive.mjs) doesn't.
import { makeBoard, put, fits, rotations, boxWeight, heightAt, layersOf, packedValue, valueOf, HEAVY } from "../src/game/engine.js";
